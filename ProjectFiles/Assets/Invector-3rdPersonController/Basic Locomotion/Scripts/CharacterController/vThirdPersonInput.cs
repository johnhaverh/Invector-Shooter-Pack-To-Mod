...
namespace Invector.vCharacterController
{
    ...
    public class vThirdPersonInput : vMonoBehaviour
    {
        ...
        public GenericInput coverInput = new GenericInput("E", "A", "A");
        ...
        protected virtual void MoveCharacter()
        {
            ...
            if (cc.input.x != 0 || cc.input.y != 0)
            {
                //Debug.Log("character is moving (" + cc.input.x + ", " + cc.input.y + ")");
                //Debug.Log("character is moving (" + cc.input.x + ", " + cc.input.y + ")");
        ...
        protected virtual void CoverInput()
        {
            if (coverInput.GetButtonDown())
                cc.Cover();
        }
        #endregion
