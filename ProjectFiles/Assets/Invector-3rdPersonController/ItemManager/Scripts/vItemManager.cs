...
namespace Invector.vItemManager
{
    ...
    public class vItemManager : vMonoBehaviour
    {
        ...
        public void DestroyItem(vItem item, int amount)
        {
                ...
                if (equipPoint != null)
                {
                    if (item.originalObject)
                    {
                        if (equipPoint.equipmentReference != null && equipPoint.equipmentReference.equipedObject != null)
                        {
                            ...
                            {
                                if (_equipmentsA[i] != null) _equipmentsA[i].OnUnequip(equipPoint.equipmentReference.item);
                            }                            
                            Destroy(equipPoint.equipmentReference.equipedObject);
                        }
                        if (!inventory.isOpen)
                        ...
                        {
                            if (_equipments[i] != null) _equipments[i].OnEquip(equipPoint.equipmentReference.item);
                        }
                    ...
                    else if (equipPoint.equipmentReference != null && equipPoint.equipmentReference.equipedObject != null)
                    {
                        ...
                        for (int i = 0; i < _equipments.Length; i++)
                        {
                            if (_equipments[i] != null) _equipments[i].OnUnequip(equipPoint.equipmentReference.item);
                        }
                        Destroy(equipPoint.equipmentReference.equipedObject);
